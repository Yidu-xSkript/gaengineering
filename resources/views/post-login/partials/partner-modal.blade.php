    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header header-color-modal bg-color-3" style="background: #ffaf00; color: #fff;">
                ...
                <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Partner Image</h4>
            ...
            <form action="/partners/{{$partner->id}}/image" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <img src="{{URL::asset('storage/app/public/uploads/partners/'.$partner->image)}}" class="img-card" style="width: 470px; height: 400px; object-fit: cover;">
