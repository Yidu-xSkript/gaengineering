	            			...
	            			<div class="card-body">
	            				...
	            				<div class="row">
	            					...
	            					<div class="col-md-2">
			              				...
			              				<a class="btn btn-success btn-block" href="/add-service" style="color: #fff;">		
	            				...
	            				<div class="row">
	            					...
	            					@include('partials.modal.service_modal')
		            				...
		            				<div class="col-md-4 mt-3">
		              					...
		              					<div class="card2">
		                                    ...
		                                    <img class="card-img-top" style="height: 250px; object-fit: cover;" src="{{URL::asset('storage/app/public/uploads/service/'.$service->image)}}" alt="{{$service->image}}">
		                                    @else
		                                    ...
		                                    <div class="card-body">
		                                        ...
		                                        <i class="@if($service->icon == 'flaticon-ideas' || $service->icon == 'flaticon-flasks' || $service->icon == 'flaticon-analysis' || $service->icon == 'flaticon-ux-design' || $service->icon == 'flaticon-web-design' || $service->icon == 'flaticon-idea' || $service->icon == 'flaticon-innovation' ){{$service->icon}}@else {{'fa '.$service->icon}} @endif" style="font-size: 30px; color: #00ce68;"></i>
