	            			...
	            			<div class="card-body">
	            				...
	            				<div class="row">
	            					...
	            					<div class="col-md-2">
			              				...
			              				<a class="btn btn-primary btn-block" href="/admin-news" style="color: #fff;">		
	            				...
	            				<div class="dropdown-divider w-25"></div>
              					...
              					<form class="forms-sample mt-4" action="/add-news" method="post" enctype="multipart/form-data">

              						@csrf

              						<div class="form-group">

					                  	<label for="title" style="font-size: 15px;">News Title <small style="color: red;">*</small></label>

					                  	<input type="text" class="form-control" name="title" id="title" placeholder="News Title" style="font-size: 15px;">
